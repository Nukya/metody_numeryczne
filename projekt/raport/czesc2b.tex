...
Zaimplementowano funkcje sklejane trzeciego stopnia zgodnie z algorytmem z podręcznika. Metoda dzieli przedział na segmenty i w każdym używa osobnego wielomianu trzeciego stopnia. Wielomiany są połączone w węzłach w sposób zapewniający ciągłość funkcji.
